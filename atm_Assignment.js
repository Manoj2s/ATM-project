...
console.log("Welcome To APNA Bank ATM");

let username = prompt("Enter Your Name :>");

let pin = Number(prompt("Enter Your PIN :>"));
if (username == "Mahi manoj") {
  if (pin == 1234) {
    console.log("Login Successfully \nYour Welcome!!");
    console.log("Do you want to continue 1:English 2: Hindi");
    let language = prompt("Enter >> ");
    if (language == "1") {
      console.log(
        "Choose Option : \n1: Check Balance \n2: Withdraw Amount \n3: Deposit Amount \n4: Reset PIN"
      );
      ...
      if (user == "1") {
        ...
        let amount = Number(
          prompt("Enter amount that you want to withdraw :> ")
        );
        ...
        if (enter_pin == 1234) {
          if (amount >= 500 && amount <= 40000) {
            ...
            let check = prompt(
              "Do you want to check your balance?? 1: Yes 2: No \nEnter >> "
            );
            if (check == 1) {
      ...
      console.log(
        "Sorry!!Currently Hindi is not available \nYou can continue in english"
      );
      console.log("if you want to continue choose options \n1: Yes \n2: No");
